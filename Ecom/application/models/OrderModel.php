...
class OrderModel extends CI_Model
{
	...
	{
		$query = $this->db->select('orders.order_code, orders.status as order_status,order_details.quantity as soluong,order_details.order_code,order_details.product_id, products.*')
			->from('order_details')
